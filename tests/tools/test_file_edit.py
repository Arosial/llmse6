...
class TestFileEdit:
    def test_write_to_file_new_file(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = write_to_file(str(file_path), content)
    ...
    def test_write_to_file_overwrite(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            result = write_to_file(str(file_path), new_content)

            assert "Successfully wrote to" in result
            assert file_path.read_text() == new_content

    def test_write_to_file_create_directories(self):
    ...
    def test_replace_in_file_simple(self):
...
>>>>>>> REPLACE"""
            ...
            result = replace_in_file(str(file_path), diff)
    ...
    def test_replace_in_file_with_placeholder(self):
...
>>>>>>> REPLACE"""
    ...
    def test_replace_in_file_not_found(self):
        """Test replacement when search content is not found"""
        with tempfile.TemporaryDirectory() as temp_dir:
            file_path = Path(temp_dir) / "test.py"
...
>>>>>>> REPLACE"""
            ...
            assert "Search content not found" in result

    def test_replace_in_file_nonexistent(self):
        """Test replacement on non-existent file"""
        result = replace_in_file("/nonexistent/file.py", "some diff")
